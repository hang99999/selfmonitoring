...
class PhaseConfig(Base):
    ...
    # 阶段1 · 启动监测
    intro_time_limit = Column(Boolean, default=False)
    ...
    # 阶段2 · 价值观 × 活动 × 计划
    setup_time_limit = Column(Boolean, default=False)
    ...
    # 阶段3 · 首次回顾
    first_review_time_limit = Column(Boolean, default=False)
    ...
    time_requirements_disabled_once = Column(Boolean, default=True)
    updated_at = Column(DateTime, default=localnow)
